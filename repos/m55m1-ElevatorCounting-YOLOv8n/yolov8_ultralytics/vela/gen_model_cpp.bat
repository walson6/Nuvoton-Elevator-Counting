...
set model_argu= --tflite_path %MODEL_SRC_DIR%\%MODEL_OPTIMISE_FILE% --output_dir %GEN_SRC_DIR% --template_dir %TEMPLATES_DIR% -ns arm -ns app -ns yoloxnanonu -e %IMAGE_SIZE_EXPR% -e %CHANNELS_EXPR% -e %CLASS_EXPR%
